...
void searchTree(Node *root, int qx, int qy, int radius, vector<string> &goneCities)
{
    ...
    if (root != NULL)
    {
        ...
        else if (rooty < ymax && rootx > xmin && distance > radius && rootx < qx && rooty > qy)
        {
            searchTree(root->se, qx, qy, radius, goneCities);
            searchTree(root->sw, qx, qy, radius, goneCities);
            searchTree(root->ne, qx, qy, radius, goneCities);
        ...
        else if (rooty < ymax && rootx < xmax && distance > radius && rootx > qx && rooty > qy)
        {
            searchTree(root->se, qx, qy, radius, goneCities);
            searchTree(root->sw, qx, qy, radius, goneCities);
            searchTree(root->nw, qx, qy, radius, goneCities);
        ...
        else if (rooty < ymin && rootx > xmin && distance > radius && rootx < qx && rooty < qy)
        {
            searchTree(root->se, qx, qy, radius, goneCities);
            searchTree(root->ne, qx, qy, radius, goneCities);
            searchTree(root->nw, qx, qy, radius, goneCities);
        ...
        else if (rooty > ymin && rootx < xmax && distance > radius && rootx > qx && rooty < qy)
        {
            searchTree(root->sw, qx, qy, radius, goneCities);
            searchTree(root->ne, qx, qy, radius, goneCities);
            searchTree(root->nw, qx, qy, radius, goneCities);
...
{
    //  EX0, EX6, EX8, 
    //  EX1, EX2, EX3, EX4, EX5, EX7, EX9    safe
    ifstream citiesFile, queryFile;
    string citiesTxt = "cities.txt", queriesTxt = "queries9.txt", boardSize, line, s;
