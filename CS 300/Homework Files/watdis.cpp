                        ...
                        if (labels[k][0] == deletedX)
                        {
                            ...
                            if (onlyLabels.size() != 0)
                            {
                                ...
                                if (yMax < labels[k][1])
                                {
                                    ...
                                    skyline.push_back({labels[k][0], yMax, labels[k][2]});
                                }
                            }
                        }
                    }
...
vector<vector<int>> setMaxHeight(const vector<vector<int>> skyline)
{
    vector<vector<int>> uniqueX;
    uniqueX = skyline;
    int tail = 0;
    for (int head = 1; head < uniqueX.size(); head++)
    {
        if (uniqueX[tail][0] == uniqueX[head][0])
        {
            int yMax = getMax(uniqueX[tail][1], uniqueX[head][1]);
...
vector<vector<int>> removeDuplicatesFromSkyline(const vector<vector<int>> skyline)
{
    vector<vector<int>> uniqueSkylines;

    int tail = 0;
    for (int head = 1; head < skyline.size(); head++)
    {
...
vector<vector<int>> removeDuplicateY(const vector<vector<int>> skyline)
{
    vector<vector<int>> uniqueY;
